...
const
  ...
  CLSID_DirectDraw7: TGUID = (D1:$3c305196;D2:$50db;D3:$11d3;d4:($9c,$fe,$00,$c0,$4f,$d9,$30,$c5));
...
{$ELSE}
	IDirectDraw = ^__IDirectDrawThis;
	IDirectDraw2 = ^__IDirectDraw2This;
	IDirectDraw4 = ^__IDirectDraw4This;
	IDirectDraw7 = ^__IDirectDraw7This;
	IDirectDrawPalette = ^__IDirectDrawPaletteThis;
	IDirectDrawClipper = ^__IDirectDrawClipperThis;
	IDirectDrawSurface = ^__IDirectDrawSurfaceThis;
	IDirectDrawSurface2 = ^__IDirectDrawSurface2This;
	IDirectDrawSurface3 = ^__IDirectDrawSurface3This;
	IDirectDrawSurface4 = ^__IDirectDrawSurface4This;
	IDirectDrawSurface7 = ^__IDirectDrawSurface7This;
	IDirectDrawColorControl = ^__IDirectDrawColorControlThis;
	IDirectDrawGammaControl = ^__IDirectDrawGammaControlThis;
{$ENDIF}
(*
...
{$ELSE}
	...
	__IDirectDrawThis = ^__IDirectDrawMethods;
	__IDirectDrawMethods = packed record
		// ( methods
		// IDirectDraw methods
		QueryInterface : function (idd : IDirectDraw; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDraw) : Longint; stdcall;
		Release : function (idd : IDirectDraw) : Longint; stdcall;
		Compact : function (idd : IDirectDraw) : HResult; stdcall;
		CreateClipper : function (idd : IDirectDraw; dwFlags : DWORD; var lplpDDClipper : IDirectDrawClipper; pUnkOuter : IUnknown) : HResult; stdcall;
		CreatePalette : function (idd : IDirectDraw; dwFlags : DWORD; lpColorTable : pointer; var lplpDDPalette : IDirectDrawPalette; pUnkOuter : IUnknown) : HResult; stdcall;
		CreateSurface : function (idd : IDirectDraw; var lpDDSurfaceDesc : TDDSurfaceDesc; var lplpDDSurface : IDirectDrawSurface; pUnkOuter : IUnknown) : HResult; stdcall;
		DuplicateSurface : function (idd : IDirectDraw; lpDDSurface : IDirectDrawSurface; var lplpDupDDSurface : IDirectDrawSurface) : HResult; stdcall;
		EnumDisplayModes : function (idd : IDirectDraw; dwFlags : DWORD; lpDDSurfaceDesc : PDDSurfaceDesc; lpContext : Pointer; lpEnumModesCallback : TDDEnumModesCallback) : HResult; stdcall;
		EnumSurfaces : function (idd : IDirectDraw; dwFlags : DWORD; const lpDDSD : TDDSurfaceDesc; lpContext : Pointer; lpEnumCallback : TDDEnumSurfacesCallback) : HResult; stdcall;
		FlipToGDISurface : function (idd : IDirectDraw) : HResult; stdcall;
		GetCaps : function (idd : IDirectDraw; lpDDDriverCaps : PDDCaps; lpDDHELCaps : PDDCaps) : HResult; stdcall;
		GetDisplayMode : function (idd : IDirectDraw; var lpDDSurfaceDesc : TDDSurfaceDesc) : HResult; stdcall;
		GetFourCCCodes : function (idd : IDirectDraw; var lpNumCodes : DWORD; lpCodes : PDWORD) : HResult; stdcall;
		GetGDISurface : function (idd : IDirectDraw; var lplpGDIDDSSurface : IDirectDrawSurface) : HResult; stdcall;
		GetMonitorFrequency : function (idd : IDirectDraw; var lpdwFrequency : DWORD) : HResult; stdcall;
		GetScanLine : function (idd : IDirectDraw; var lpdwScanLine : DWORD) : HResult; stdcall;
		GetVerticalBlankStatus : function (idd : IDirectDraw; var lpbIsInVB : BOOL) : HResult; stdcall;
		Initialize : function (idd : IDirectDraw; lpGUID : PGUID) : HResult; stdcall;
		RestoreDisplayMode : function (idd : IDirectDraw) : HResult; stdcall;
		SetCooperativeLevel : function (idd : IDirectDraw; hWnd : HWND; dwFlags : DWORD) : HResult; stdcall;
		SetDisplayMode : function (idd : IDirectDraw; dwWidth : DWORD; dwHeight : DWORD; dwBpp : DWORD) : HResult; stdcall;
		WaitForVerticalBlank : function (idd : IDirectDraw; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
	end;

	__IDirectDraw2This = ^__IDirectDraw2Methods;
	__IDirectDraw2Methods = packed record
		// ( methods
		// IDirectDraw2 methods
		QueryInterface : function (idd : IDirectDraw2; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDraw2) : Longint; stdcall;
		Release : function (idd : IDirectDraw2) : Longint; stdcall;
		Compact : function (idd : IDirectDraw2) : HResult; stdcall;
		CreateClipper : function (idd : IDirectDraw2; dwFlags : DWORD; var lplpDDClipper : IDirectDrawClipper; pUnkOuter : IUnknown) : HResult; stdcall;
		CreatePalette : function (idd : IDirectDraw2; dwFlags : DWORD; lpColorTable : pointer; var lplpDDPalette : IDirectDrawPalette; pUnkOuter : IUnknown) : HResult; stdcall;
		CreateSurface : function (idd : IDirectDraw2; var lpDDSurfaceDesc : TDDSurfaceDesc; var lplpDDSurface : IDirectDrawSurface; pUnkOuter : IUnknown) : HResult; stdcall;
		DuplicateSurface : function (idd : IDirectDraw2; lpDDSurface : IDirectDrawSurface; var lplpDupDDSurface : IDirectDrawSurface) : HResult; stdcall;
		EnumDisplayModes : function (idd : IDirectDraw2; dwFlags : DWORD; lpDDSurfaceDesc : PDDSurfaceDesc; lpContext : Pointer; lpEnumModesCallback : TDDEnumModesCallback) : HResult; stdcall;
		EnumSurfaces : function (idd : IDirectDraw2; dwFlags : DWORD; var lpDDSD : TDDSurfaceDesc; lpContext : Pointer; lpEnumCallback : TDDEnumSurfacesCallback) : HResult; stdcall;
		FlipToGDISurface : function (idd : IDirectDraw2) : HResult; stdcall;
		GetCaps : function (idd : IDirectDraw2; lpDDDriverCaps : PDDCaps; lpDDHELCaps : PDDCaps) : HResult; stdcall;
		GetDisplayMode : function (idd : IDirectDraw2; var lpDDSurfaceDesc : TDDSurfaceDesc) : HResult; stdcall;
		GetFourCCCodes : function (idd : IDirectDraw2; var lpNumCodes : DWORD; lpCodes : PDWORD) : HResult; stdcall;
		GetGDISurface : function (idd : IDirectDraw2; var lplpGDIDDSSurface : IDirectDrawSurface) : HResult; stdcall;
		GetMonitorFrequency : function (idd : IDirectDraw2; var lpdwFrequency : DWORD) : HResult; stdcall;
		GetScanLine : function (idd : IDirectDraw2; var lpdwScanLine : DWORD) : HResult; stdcall;
		GetVerticalBlankStatus : function (idd : IDirectDraw2; var lpbIsInVB : BOOL) : HResult; stdcall;
		Initialize : function (idd : IDirectDraw2; lpGUID : PGUID) : HResult; stdcall;
		RestoreDisplayMode : function (idd : IDirectDraw2) : HResult; stdcall;
		SetCooperativeLevel : function (idd : IDirectDraw2; hWnd : HWND; dwFlags : DWORD) : HResult; stdcall;
		SetDisplayMode : function (idd : IDirectDraw2; dwWidth : DWORD; dwHeight : DWORD; dwBPP : DWORD; dwRefreshRate : DWORD; dwFlags : DWORD) : HResult; stdcall;
		WaitForVerticalBlank : function (idd : IDirectDraw2; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
		GetAvailableVidMem : function (idd : IDirectDraw2; var lpDDSCaps : TDDSCaps; var lpdwTotal , lpdwFree : DWORD) : HResult; stdcall;
	end;

	__IDirectDraw4This = ^__IDirectDraw4Methods;
	__IDirectDraw4Methods = packed record
		// ( methods
		// IDirectDraw4 methods
		QueryInterface : function (idd : IDirectDraw4; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDraw4) : Longint; stdcall;
		Release : function (idd : IDirectDraw4) : Longint; stdcall;
		Compact : function (idd : IDirectDraw4) : HResult; stdcall;
		CreateClipper : function (idd : IDirectDraw4; dwFlags : DWORD; var lplpDDClipper : IDirectDrawClipper; pUnkOuter : IUnknown) : HResult; stdcall;
		CreatePalette : function (idd : IDirectDraw4; dwFlags : DWORD; lpColorTable : pointer; var lplpDDPalette : IDirectDrawPalette; pUnkOuter : IUnknown) : HResult; stdcall;
		CreateSurface : function (idd : IDirectDraw4; const lpDDSurfaceDesc : TDDSurfaceDesc2; var lplpDDSurface : IDirectDrawSurface4; pUnkOuter : IUnknown) : HResult; stdcall;
		DuplicateSurface : function (idd : IDirectDraw4; lpDDSurface : IDirectDrawSurface4; var lplpDupDDSurface : IDirectDrawSurface4) : HResult; stdcall;
		EnumDisplayModes : function (idd : IDirectDraw4; dwFlags : DWORD; lpDDSurfaceDesc : PDDSurfaceDesc2; lpContext : Pointer; lpEnumModesCallback : TDDEnumModesCallback2) : HResult; stdcall;
		EnumSurfaces : function (idd : IDirectDraw4; dwFlags : DWORD; const lpDDSD : TDDSurfaceDesc2; lpContext : Pointer; lpEnumCallback : TDDEnumSurfacesCallback2) : HResult; stdcall;
		FlipToGDISurface : function (idd : IDirectDraw4) : HResult; stdcall;
		GetCaps : function (idd : IDirectDraw4; lpDDDriverCaps : PDDCaps; lpDDHELCaps : PDDCaps) : HResult; stdcall;
		GetDisplayMode : function (idd : IDirectDraw4; var lpDDSurfaceDesc : TDDSurfaceDesc2) : HResult; stdcall;
		GetFourCCCodes : function (idd : IDirectDraw4; var lpNumCodes : DWORD; lpCodes : PDWORD) : HResult; stdcall;
		GetGDISurface : function (idd : IDirectDraw4; var lplpGDIDDSSurface : IDirectDrawSurface4) : HResult; stdcall;
		GetMonitorFrequency : function (idd : IDirectDraw4; var lpdwFrequency : DWORD) : HResult; stdcall;
		GetScanLine : function (idd : IDirectDraw4; var lpdwScanLine : DWORD) : HResult; stdcall;
		GetVerticalBlankStatus : function (idd : IDirectDraw4; var lpbIsInVB : BOOL) : HResult; stdcall;
		Initialize : function (idd : IDirectDraw4; lpGUID : PGUID) : HResult; stdcall;
		RestoreDisplayMode : function (idd : IDirectDraw4) : HResult; stdcall;
		SetCooperativeLevel : function (idd : IDirectDraw4; hWnd : HWND; dwFlags : DWORD) : HResult; stdcall;
		SetDisplayMode : function (idd : IDirectDraw4; dwWidth : DWORD; dwHeight : DWORD; dwBPP : DWORD; dwRefreshRate : DWORD; dwFlags : DWORD) : HResult; stdcall;
		WaitForVerticalBlank : function (idd : IDirectDraw4; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
		GetAvailableVidMem : function (idd : IDirectDraw4; const lpDDSCaps : TDDSCaps2; var lpdwTotal , lpdwFree : DWORD) : HResult; stdcall;
		GetSurfaceFromDC : function (idd : IDirectDraw4; hdc : Windows.HDC; var lpDDS4 : IDirectDrawSurface4) : HResult; stdcall;
		RestoreAllSurfaces : function (idd : IDirectDraw4) : HResult; stdcall;
		TestCooperativeLevel : function (idd : IDirectDraw4) : HResult; stdcall;
		GetDeviceIdentifier : function (idd : IDirectDraw4; var lpdddi : TDDDeviceIdentifier; dwFlags : DWORD) : HResult; stdcall;
	end;

	__IDirectDraw7This = ^__IDirectDraw7Methods;
	__IDirectDraw7Methods = packed record
		// ( methods
		// IDirectDraw7 methods
		QueryInterface : function (idd : IDirectDraw7; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDraw7) : Longint; stdcall;
		Release : function (idd : IDirectDraw7) : Longint; stdcall;
		Compact : function (idd : IDirectDraw7) : HResult; stdcall;
		CreateClipper : function (idd : IDirectDraw7; dwFlags : DWORD; var lplpDDClipper : IDirectDrawClipper; pUnkOuter : IUnknown) : HResult; stdcall;
		CreatePalette : function (idd : IDirectDraw7; dwFlags : DWORD; lpColorTable : pointer; var lplpDDPalette : IDirectDrawPalette; pUnkOuter : IUnknown) : HResult; stdcall;
		CreateSurface : function (idd : IDirectDraw7; const lpDDSurfaceDesc : TDDSurfaceDesc2; var lplpDDSurface : IDirectDrawSurface7; pUnkOuter : IUnknown) : HResult; stdcall;
		DuplicateSurface : function (idd : IDirectDraw7; lpDDSurface : IDirectDrawSurface7; var lplpDupDDSurface : IDirectDrawSurface7) : HResult; stdcall;
		EnumDisplayModes : function (idd : IDirectDraw7; dwFlags : DWORD; lpDDSurfaceDesc : PDDSurfaceDesc2; lpContext : Pointer; lpEnumModesCallback : TDDEnumModesCallback2) : HResult; stdcall;
		EnumSurfaces : function (idd : IDirectDraw7; dwFlags : DWORD; const lpDDSD : TDDSurfaceDesc2; lpContext : Pointer; lpEnumCallback : TDDEnumSurfacesCallback7) : HResult; stdcall;
		FlipToGDISurface : function (idd : IDirectDraw7) : HResult; stdcall;
		GetCaps : function (idd : IDirectDraw7; lpDDDriverCaps : PDDCaps; lpDDHELCaps : PDDCaps) : HResult; stdcall;
		GetDisplayMode : function (idd : IDirectDraw7; var lpDDSurfaceDesc : TDDSurfaceDesc2) : HResult; stdcall;
		GetFourCCCodes : function (idd : IDirectDraw7; var lpNumCodes : DWORD; lpCodes : PDWORD) : HResult; stdcall;
		GetGDISurface : function (idd : IDirectDraw7; var lplpGDIDDSSurface : IDirectDrawSurface7) : HResult; stdcall;
		GetMonitorFrequency : function (idd : IDirectDraw7; var lpdwFrequency : DWORD) : HResult; stdcall;
		GetScanLine : function (idd : IDirectDraw7; var lpdwScanLine : DWORD) : HResult; stdcall;
		GetVerticalBlankStatus : function (idd : IDirectDraw7; var lpbIsInVB : BOOL) : HResult; stdcall;
		Initialize : function (idd : IDirectDraw7; lpGUID : PGUID) : HResult; stdcall;
		RestoreDisplayMode : function (idd : IDirectDraw7) : HResult; stdcall;
		SetCooperativeLevel : function (idd : IDirectDraw7; hWnd : HWND; dwFlags : DWORD) : HResult; stdcall;
		SetDisplayMode : function (idd : IDirectDraw7; dwWidth : DWORD; dwHeight : DWORD; dwBPP : DWORD; dwRefreshRate : DWORD; dwFlags : DWORD) : HResult; stdcall;
		WaitForVerticalBlank : function (idd : IDirectDraw7; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
		GetAvailableVidMem : function (idd : IDirectDraw7; const lpDDSCaps : TDDSCaps2; var lpdwTotal , lpdwFree : DWORD) : HResult; stdcall;
		GetSurfaceFromDC : function (idd : IDirectDraw7; hdc : Windows.HDC; var lpDDS : IDirectDrawSurface7) : HResult; stdcall;
		RestoreAllSurfaces : function (idd : IDirectDraw7) : HResult; stdcall;
		TestCooperativeLevel : function (idd : IDirectDraw7) : HResult; stdcall;
		GetDeviceIdentifier : function (idd : IDirectDraw7; var lpdddi : TDDDeviceIdentifier2; dwFlags : DWORD) : HResult; stdcall;
		StartModeTest : function (idd : IDirectDraw7; const lpModesToTest; dwNumEntries , dwFlags : DWORD) : HResult; stdcall;
		EvaluateMode : function (idd : IDirectDraw7; dwFlags : DWORD; var pSecondsUntilTimeout : DWORD) : HResult; stdcall;
	end;

	__IDirectDrawPaletteThis = ^__IDirectDrawPaletteMethods;
	__IDirectDrawPaletteMethods = packed record
		// ( methods
		// IDirectDrawPalette methods
		QueryInterface : function (idd : IDirectDrawPalette; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawPalette) : Longint; stdcall;
		Release : function (idd : IDirectDrawPalette) : Longint; stdcall;
		GetCaps : function (idd : IDirectDrawPalette; var lpdwCaps : DWORD) : HResult; stdcall;
		GetEntries : function (idd : IDirectDrawPalette; dwFlags : DWORD; dwBase : DWORD; dwNumEntries : DWORD; lpEntries : pointer) : HResult; stdcall;
		Initialize : function (idd : IDirectDrawPalette; lpDD : IDirectDraw; dwFlags : DWORD; lpDDColorTable : pointer) : HResult; stdcall;
		SetEntries : function (idd : IDirectDrawPalette; dwFlags : DWORD; dwStartingEntry : DWORD; dwCount : DWORD; lpEntries : pointer) : HResult; stdcall;
	end;

	__IDirectDrawClipperThis = ^__IDirectDrawClipperMethods;
	__IDirectDrawClipperMethods = packed record
		// ( methods
		// IDirectDrawClipper methods
		QueryInterface : function (idd : IDirectDrawClipper; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawClipper) : Longint; stdcall;
		Release : function (idd : IDirectDrawClipper) : Longint; stdcall;
		GetClipList : function (idd : IDirectDrawClipper; lpRect : PRect; lpClipList : PRgnData; var lpdwSize : DWORD) : HResult; stdcall;
		GetHWnd : function (idd : IDirectDrawClipper; var lphWnd : HWND) : HResult; stdcall;
		Initialize : function (idd : IDirectDrawClipper; lpDD : IDirectDraw; dwFlags : DWORD) : HResult; stdcall;
		IsClipListChanged : function (idd : IDirectDrawClipper; var lpbChanged : BOOL) : HResult; stdcall;
		SetClipList : function (idd : IDirectDrawClipper; lpClipList : PRgnData; dwFlags : DWORD) : HResult; stdcall;
		SetHWnd : function (idd : IDirectDrawClipper; dwFlags : DWORD; hWnd : HWND) : HResult; stdcall;
	end;

	__IDirectDrawSurfaceThis = ^__IDirectDrawSurfaceMethods;
	__IDirectDrawSurfaceMethods = packed record
		// ( methods
		// IDirectDrawSurface methods
		QueryInterface : function (idd : IDirectDrawSurface; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawSurface) : Longint; stdcall;
		Release : function (idd : IDirectDrawSurface) : Longint; stdcall;
		AddAttachedSurface : function (idd : IDirectDrawSurface; lpDDSAttachedSurface : IDirectDrawSurface) : HResult; stdcall;
		AddOverlayDirtyRect : function (idd : IDirectDrawSurface; const lpRect : TRect) : HResult; stdcall;
		Blt : function (idd : IDirectDrawSurface; lpDestRect : PRect; lpDDSrcSurface : IDirectDrawSurface; lpSrcRect : PRect; dwFlags : DWORD; lpDDBltFx : PDDBltFX) : HResult; stdcall;
		BltBatch : function (idd : IDirectDrawSurface; const lpDDBltBatch : TDDBltBatch; dwCount : DWORD; dwFlags : DWORD) : HResult; stdcall;
		BltFast : function (idd : IDirectDrawSurface; dwX : DWORD; dwY : DWORD; lpDDSrcSurface : IDirectDrawSurface; lpSrcRect : PRect; dwTrans : DWORD) : HResult; stdcall;
		DeleteAttachedSurface : function (idd : IDirectDrawSurface; dwFlags : DWORD; lpDDSAttachedSurface : IDirectDrawSurface) : HResult; stdcall;
		EnumAttachedSurfaces : function (idd : IDirectDrawSurface; lpContext : Pointer; lpEnumSurfacesCallback : TDDEnumSurfacesCallback) : HResult; stdcall;
		EnumOverlayZOrders : function (idd : IDirectDrawSurface; dwFlags : DWORD; lpContext : Pointer; lpfnCallback : TDDEnumSurfacesCallback) : HResult; stdcall;
		Flip : function (idd : IDirectDrawSurface; lpDDSurfaceTargetOverride : IDirectDrawSurface; dwFlags : DWORD) : HResult; stdcall;
		GetAttachedSurface : function (idd : IDirectDrawSurface; var lpDDSCaps : TDDSCaps; var lplpDDAttachedSurface : IDirectDrawSurface) : HResult; stdcall;
		GetBltStatus : function (idd : IDirectDrawSurface; dwFlags : DWORD) : HResult; stdcall;
		GetCaps : function (idd : IDirectDrawSurface; var lpDDSCaps : TDDSCaps) : HResult; stdcall;
		GetClipper : function (idd : IDirectDrawSurface; var lplpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		GetColorKey : function (idd : IDirectDrawSurface; dwFlags : DWORD; var lpDDColorKey : TDDColorKey) : HResult; stdcall;
		GetDC : function (idd : IDirectDrawSurface; var lphDC : HDC) : HResult; stdcall;
		GetFlipStatus : function (idd : IDirectDrawSurface; dwFlags : DWORD) : HResult; stdcall;
		GetOverlayPosition : function (idd : IDirectDrawSurface; var lplX , lplY : LongInt) : HResult; stdcall;
		GetPalette : function (idd : IDirectDrawSurface; var lplpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		GetPixelFormat : function (idd : IDirectDrawSurface; var lpDDPixelFormat : TDDPixelFormat) : HResult; stdcall;
		GetSurfaceDesc : function (idd : IDirectDrawSurface; var lpDDSurfaceDesc : TDDSurfaceDesc) : HResult; stdcall;
		Initialize : function (idd : IDirectDrawSurface; lpDD : IDirectDraw; var lpDDSurfaceDesc : TDDSurfaceDesc) : HResult; stdcall;
		IsLost : function (idd : IDirectDrawSurface) : HResult; stdcall;
		Lock : function (idd : IDirectDrawSurface; lpDestRect : PRect; var lpDDSurfaceDesc : TDDSurfaceDesc; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
		ReleaseDC : function (idd : IDirectDrawSurface; hDC : Windows.HDC) : HResult; stdcall;
		_Restore : function (idd : IDirectDrawSurface) : HResult; stdcall;
		SetClipper : function (idd : IDirectDrawSurface; lpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		SetColorKey : function (idd : IDirectDrawSurface; dwFlags : DWORD; lpDDColorKey : PDDColorKey) : HResult; stdcall;
		SetOverlayPosition : function (idd : IDirectDrawSurface; lX , lY : LongInt) : HResult; stdcall;
		SetPalette : function (idd : IDirectDrawSurface; lpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		Unlock : function (idd : IDirectDrawSurface; lpSurfaceData : Pointer) : HResult; stdcall;
		UpdateOverlay : function (idd : IDirectDrawSurface; lpSrcRect : PRect; lpDDDestSurface : IDirectDrawSurface; lpDestRect : PRect; dwFlags : DWORD; lpDDOverlayFx : PDDOverlayFX) : HResult; stdcall;
		UpdateOverlayDisplay : function (idd : IDirectDrawSurface; dwFlags : DWORD) : HResult; stdcall;
		UpdateOverlayZOrder : function (idd : IDirectDrawSurface; dwFlags : DWORD; lpDDSReference : IDirectDrawSurface) : HResult; stdcall;
	end;

	__IDirectDrawSurface2This = ^__IDirectDrawSurface2Methods;
	__IDirectDrawSurface2Methods = packed record
		// ( methods
		// IDirectDrawSurface2 methods
		QueryInterface : function (idd : IDirectDrawSurface2; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawSurface2) : Longint; stdcall;
		Release : function (idd : IDirectDrawSurface2) : Longint; stdcall;
		AddAttachedSurface : function (idd : IDirectDrawSurface2; lpDDSAttachedSurface : IDirectDrawSurface2) : HResult; stdcall;
		AddOverlayDirtyRect : function (idd : IDirectDrawSurface2; const lpRect : TRect) : HResult; stdcall;
		Blt : function (idd : IDirectDrawSurface2; lpDestRect : PRect; lpDDSrcSurface : IDirectDrawSurface2; lpSrcRect : PRect; dwFlags : DWORD; lpDDBltFx : PDDBltFX) : HResult; stdcall;
		BltBatch : function (idd : IDirectDrawSurface2; const lpDDBltBatch : TDDBltBatch; dwCount : DWORD; dwFlags : DWORD) : HResult; stdcall;
		BltFast : function (idd : IDirectDrawSurface2; dwX : DWORD; dwY : DWORD; lpDDSrcSurface : IDirectDrawSurface2; lpSrcRect : PRect; dwTrans : DWORD) : HResult; stdcall;
		DeleteAttachedSurface : function (idd : IDirectDrawSurface2; dwFlags : DWORD; lpDDSAttachedSurface : IDirectDrawSurface2) : HResult; stdcall;
		EnumAttachedSurfaces : function (idd : IDirectDrawSurface2; lpContext : Pointer; lpEnumSurfacesCallback : TDDEnumSurfacesCallback) : HResult; stdcall;
		EnumOverlayZOrders : function (idd : IDirectDrawSurface2; dwFlags : DWORD; lpContext : Pointer; lpfnCallback : TDDEnumSurfacesCallback) : HResult; stdcall;
		Flip : function (idd : IDirectDrawSurface2; lpDDSurfaceTargetOverride : IDirectDrawSurface2; dwFlags : DWORD) : HResult; stdcall;
		GetAttachedSurface : function (idd : IDirectDrawSurface2; var lpDDSCaps : TDDSCaps; var lplpDDAttachedSurface : IDirectDrawSurface2) : HResult; stdcall;
		GetBltStatus : function (idd : IDirectDrawSurface2; dwFlags : DWORD) : HResult; stdcall;
		GetCaps : function (idd : IDirectDrawSurface2; var lpDDSCaps : TDDSCaps) : HResult; stdcall;
		GetClipper : function (idd : IDirectDrawSurface2; var lplpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		GetColorKey : function (idd : IDirectDrawSurface2; dwFlags : DWORD; var lpDDColorKey : TDDColorKey) : HResult; stdcall;
		GetDC : function (idd : IDirectDrawSurface2; var lphDC : HDC) : HResult; stdcall;
		GetFlipStatus : function (idd : IDirectDrawSurface2; dwFlags : DWORD) : HResult; stdcall;
		GetOverlayPosition : function (idd : IDirectDrawSurface2; var lplX , lplY : LongInt) : HResult; stdcall;
		GetPalette : function (idd : IDirectDrawSurface2; var lplpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		GetPixelFormat : function (idd : IDirectDrawSurface2; var lpDDPixelFormat : TDDPixelFormat) : HResult; stdcall;
		GetSurfaceDesc : function (idd : IDirectDrawSurface2; var lpDDSurfaceDesc : TDDSurfaceDesc) : HResult; stdcall;
		Initialize : function (idd : IDirectDrawSurface2; lpDD : IDirectDraw; var lpDDSurfaceDesc : TDDSurfaceDesc) : HResult; stdcall;
		IsLost : function (idd : IDirectDrawSurface2) : HResult; stdcall;
		Lock : function (idd : IDirectDrawSurface2; lpDestRect : PRect; var lpDDSurfaceDesc : TDDSurfaceDesc; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
		ReleaseDC : function (idd : IDirectDrawSurface2; hDC : Windows.HDC) : HResult; stdcall;
		_Restore : function (idd : IDirectDrawSurface2) : HResult; stdcall;
		SetClipper : function (idd : IDirectDrawSurface2; lpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		SetColorKey : function (idd : IDirectDrawSurface2; dwFlags : DWORD; lpDDColorKey : PDDColorKey) : HResult; stdcall;
		SetOverlayPosition : function (idd : IDirectDrawSurface2; lX , lY : LongInt) : HResult; stdcall;
		SetPalette : function (idd : IDirectDrawSurface2; lpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		Unlock : function (idd : IDirectDrawSurface2; lpSurfaceData : Pointer) : HResult; stdcall;
		UpdateOverlay : function (idd : IDirectDrawSurface2; lpSrcRect : PRect; lpDDDestSurface : IDirectDrawSurface2; lpDestRect : PRect; dwFlags : DWORD; lpDDOverlayFx : PDDOverlayFX) : HResult; stdcall;
		UpdateOverlayDisplay : function (idd : IDirectDrawSurface2; dwFlags : DWORD) : HResult; stdcall;
		UpdateOverlayZOrder : function (idd : IDirectDrawSurface2; dwFlags : DWORD; lpDDSReference : IDirectDrawSurface2) : HResult; stdcall;
		GetDDInterface : function (idd : IDirectDrawSurface2; var lplpDD : IDirectDraw) : HResult; stdcall;
		PageLock : function (idd : IDirectDrawSurface2; dwFlags : DWORD) : HResult; stdcall;
		PageUnlock : function (idd : IDirectDrawSurface2; dwFlags : DWORD) : HResult; stdcall;
	end;

	__IDirectDrawSurface3This = ^__IDirectDrawSurface3Methods;
	__IDirectDrawSurface3Methods = packed record
		// ( methods
		// IDirectDrawSurface3 methods
		QueryInterface : function (idd : IDirectDrawSurface3; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawSurface3) : Longint; stdcall;
		Release : function (idd : IDirectDrawSurface3) : Longint; stdcall;
		AddAttachedSurface : function (idd : IDirectDrawSurface3; lpDDSAttachedSurface : IDirectDrawSurface3) : HResult; stdcall;
		AddOverlayDirtyRect : function (idd : IDirectDrawSurface3; const lpRect : TRect) : HResult; stdcall;
		Blt : function (idd : IDirectDrawSurface3; lpDestRect : PRect; lpDDSrcSurface : IDirectDrawSurface3; lpSrcRect : PRect; dwFlags : DWORD; lpDDBltFx : PDDBltFX) : HResult; stdcall;
		BltBatch : function (idd : IDirectDrawSurface3; const lpDDBltBatch : TDDBltBatch; dwCount : DWORD; dwFlags : DWORD) : HResult; stdcall;
		BltFast : function (idd : IDirectDrawSurface3; dwX : DWORD; dwY : DWORD; lpDDSrcSurface : IDirectDrawSurface3; lpSrcRect : PRect; dwTrans : DWORD) : HResult; stdcall;
		DeleteAttachedSurface : function (idd : IDirectDrawSurface3; dwFlags : DWORD; lpDDSAttachedSurface : IDirectDrawSurface3) : HResult; stdcall;
		EnumAttachedSurfaces : function (idd : IDirectDrawSurface3; lpContext : Pointer; lpEnumSurfacesCallback : TDDEnumSurfacesCallback) : HResult; stdcall;
		EnumOverlayZOrders : function (idd : IDirectDrawSurface3; dwFlags : DWORD; lpContext : Pointer; lpfnCallback : TDDEnumSurfacesCallback) : HResult; stdcall;
		Flip : function (idd : IDirectDrawSurface3; lpDDSurfaceTargetOverride : IDirectDrawSurface3; dwFlags : DWORD) : HResult; stdcall;
		GetAttachedSurface : function (idd : IDirectDrawSurface3; var lpDDSCaps : TDDSCaps; var lplpDDAttachedSurface : IDirectDrawSurface3) : HResult; stdcall;
		GetBltStatus : function (idd : IDirectDrawSurface3; dwFlags : DWORD) : HResult; stdcall;
		GetCaps : function (idd : IDirectDrawSurface3; var lpDDSCaps : TDDSCaps) : HResult; stdcall;
		GetClipper : function (idd : IDirectDrawSurface3; var lplpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		GetColorKey : function (idd : IDirectDrawSurface3; dwFlags : DWORD; var lpDDColorKey : TDDColorKey) : HResult; stdcall;
		GetDC : function (idd : IDirectDrawSurface3; var lphDC : HDC) : HResult; stdcall;
		GetFlipStatus : function (idd : IDirectDrawSurface3; dwFlags : DWORD) : HResult; stdcall;
		GetOverlayPosition : function (idd : IDirectDrawSurface3; var lplX , lplY : LongInt) : HResult; stdcall;
		GetPalette : function (idd : IDirectDrawSurface3; var lplpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		GetPixelFormat : function (idd : IDirectDrawSurface3; var lpDDPixelFormat : TDDPixelFormat) : HResult; stdcall;
		GetSurfaceDesc : function (idd : IDirectDrawSurface3; var lpDDSurfaceDesc : TDDSurfaceDesc) : HResult; stdcall;
		Initialize : function (idd : IDirectDrawSurface3; lpDD : IDirectDraw; var lpDDSurfaceDesc : TDDSurfaceDesc) : HResult; stdcall;
		IsLost : function (idd : IDirectDrawSurface3) : HResult; stdcall;
		Lock : function (idd : IDirectDrawSurface3; lpDestRect : PRect; var lpDDSurfaceDesc : TDDSurfaceDesc; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
		ReleaseDC : function (idd : IDirectDrawSurface3; hDC : Windows.HDC) : HResult; stdcall;
		_Restore : function (idd : IDirectDrawSurface3) : HResult; stdcall;
		SetClipper : function (idd : IDirectDrawSurface3; lpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		SetColorKey : function (idd : IDirectDrawSurface3; dwFlags : DWORD; lpDDColorKey : PDDColorKey) : HResult; stdcall;
		SetOverlayPosition : function (idd : IDirectDrawSurface3; lX , lY : LongInt) : HResult; stdcall;
		SetPalette : function (idd : IDirectDrawSurface3; lpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		Unlock : function (idd : IDirectDrawSurface3; lpSurfaceData : Pointer) : HResult; stdcall;
		UpdateOverlay : function (idd : IDirectDrawSurface3; lpSrcRect : PRect; lpDDDestSurface : IDirectDrawSurface3; lpDestRect : PRect; dwFlags : DWORD; lpDDOverlayFx : PDDOverlayFX) : HResult; stdcall;
		UpdateOverlayDisplay : function (idd : IDirectDrawSurface3; dwFlags : DWORD) : HResult; stdcall;
		UpdateOverlayZOrder : function (idd : IDirectDrawSurface3; dwFlags : DWORD; lpDDSReference : IDirectDrawSurface3) : HResult; stdcall;
		GetDDInterface : function (idd : IDirectDrawSurface3; var lplpDD : IDirectDraw) : HResult; stdcall;
		PageLock : function (idd : IDirectDrawSurface3; dwFlags : DWORD) : HResult; stdcall;
		PageUnlock : function (idd : IDirectDrawSurface3; dwFlags : DWORD) : HResult; stdcall;
		SetSurfaceDesc : function (idd : IDirectDrawSurface3; const lpddsd : TDDSurfaceDesc; dwFlags : DWORD) : HResult; stdcall;
	end;

	__IDirectDrawSurface4This = ^__IDirectDrawSurface4Methods;
	__IDirectDrawSurface4Methods = packed record
		// ( methods
		// IDirectDrawSurface4 methods
		QueryInterface : function (idd : IDirectDrawSurface4; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawSurface4) : Longint; stdcall;
		Release : function (idd : IDirectDrawSurface4) : Longint; stdcall;
		AddAttachedSurface : function (idd : IDirectDrawSurface4; lpDDSAttachedSurface : IDirectDrawSurface4) : HResult; stdcall;
		AddOverlayDirtyRect : function (idd : IDirectDrawSurface4; const lpRect : TRect) : HResult; stdcall;
		Blt : function (idd : IDirectDrawSurface4; lpDestRect : PRect; lpDDSrcSurface : IDirectDrawSurface4; lpSrcRect : PRect; dwFlags : DWORD; lpDDBltFx : PDDBltFX) : HResult; stdcall;
		BltBatch : function (idd : IDirectDrawSurface4; const lpDDBltBatch : TDDBltBatch; dwCount : DWORD; dwFlags : DWORD) : HResult; stdcall;
		BltFast : function (idd : IDirectDrawSurface4; dwX : DWORD; dwY : DWORD; lpDDSrcSurface : IDirectDrawSurface4; lpSrcRect : PRect; dwTrans : DWORD) : HResult; stdcall;
		DeleteAttachedSurface : function (idd : IDirectDrawSurface4; dwFlags : DWORD; lpDDSAttachedSurface : IDirectDrawSurface4) : HResult; stdcall;
		EnumAttachedSurfaces : function (idd : IDirectDrawSurface4; lpContext : Pointer; lpEnumSurfacesCallback : TDDEnumSurfacesCallback2) : HResult; stdcall;
		EnumOverlayZOrders : function (idd : IDirectDrawSurface4; dwFlags : DWORD; lpContext : Pointer; lpfnCallback : TDDEnumSurfacesCallback2) : HResult; stdcall;
		Flip : function (idd : IDirectDrawSurface4; lpDDSurfaceTargetOverride : IDirectDrawSurface4; dwFlags : DWORD) : HResult; stdcall;
		GetAttachedSurface : function (idd : IDirectDrawSurface4; const lpDDSCaps : TDDSCaps2; var lplpDDAttachedSurface : IDirectDrawSurface4) : HResult; stdcall;
		GetBltStatus : function (idd : IDirectDrawSurface4; dwFlags : DWORD) : HResult; stdcall;
		GetCaps : function (idd : IDirectDrawSurface4; var lpDDSCaps : TDDSCaps2) : HResult; stdcall;
		GetClipper : function (idd : IDirectDrawSurface4; var lplpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		GetColorKey : function (idd : IDirectDrawSurface4; dwFlags : DWORD; var lpDDColorKey : TDDColorKey) : HResult; stdcall;
		GetDC : function (idd : IDirectDrawSurface4; var lphDC : HDC) : HResult; stdcall;
		GetFlipStatus : function (idd : IDirectDrawSurface4; dwFlags : DWORD) : HResult; stdcall;
		GetOverlayPosition : function (idd : IDirectDrawSurface4; var lplX , lplY : LongInt) : HResult; stdcall;
		GetPalette : function (idd : IDirectDrawSurface4; var lplpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		GetPixelFormat : function (idd : IDirectDrawSurface4; var lpDDPixelFormat : TDDPixelFormat) : HResult; stdcall;
		GetSurfaceDesc : function (idd : IDirectDrawSurface4; var lpDDSurfaceDesc : TDDSurfaceDesc2) : HResult; stdcall;
		Initialize : function (idd : IDirectDrawSurface4; lpDD : IDirectDraw; var lpDDSurfaceDesc : TDDSurfaceDesc2) : HResult; stdcall;
		IsLost : function (idd : IDirectDrawSurface4) : HResult; stdcall;
		Lock : function (idd : IDirectDrawSurface4; lpDestRect : PRect; var lpDDSurfaceDesc : TDDSurfaceDesc2; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
		ReleaseDC : function (idd : IDirectDrawSurface4; hDC : Windows.HDC) : HResult; stdcall;
		_Restore : function (idd : IDirectDrawSurface4) : HResult; stdcall;
		SetClipper : function (idd : IDirectDrawSurface4; lpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		SetColorKey : function (idd : IDirectDrawSurface4; dwFlags : DWORD; lpDDColorKey : PDDColorKey) : HResult; stdcall;
		SetOverlayPosition : function (idd : IDirectDrawSurface4; lX , lY : LongInt) : HResult; stdcall;
		SetPalette : function (idd : IDirectDrawSurface4; lpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		Unlock : function (idd : IDirectDrawSurface4; lpRect : PRect) : HResult; stdcall;
		UpdateOverlay : function (idd : IDirectDrawSurface4; lpSrcRect : PRect; lpDDDestSurface : IDirectDrawSurface4; lpDestRect : PRect; dwFlags : DWORD; lpDDOverlayFx : PDDOverlayFX) : HResult; stdcall;
		UpdateOverlayDisplay : function (idd : IDirectDrawSurface4; dwFlags : DWORD) : HResult; stdcall;
		UpdateOverlayZOrder : function (idd : IDirectDrawSurface4; dwFlags : DWORD; lpDDSReference : IDirectDrawSurface4) : HResult; stdcall;
		GetDDInterface : function (idd : IDirectDrawSurface4; var lplpDD : IUnknown) : HResult; stdcall;
		PageLock : function (idd : IDirectDrawSurface4; dwFlags : DWORD) : HResult; stdcall;
		PageUnlock : function (idd : IDirectDrawSurface4; dwFlags : DWORD) : HResult; stdcall;
		SetSurfaceDesc : function (idd : IDirectDrawSurface4; const lpddsd2 : TDDSurfaceDesc2; dwFlags : DWORD) : HResult; stdcall;
		SetPrivateData : function (idd : IDirectDrawSurface4; const guidTag : TGUID; lpData : pointer; cbSize : DWORD; dwFlags : DWORD) : HResult; stdcall;
		GetPrivateData : function (idd : IDirectDrawSurface4; const guidTag : TGUID; lpBuffer : pointer; var lpcbBufferSize : DWORD) : HResult; stdcall;
		FreePrivateData : function (idd : IDirectDrawSurface4; const guidTag : TGUID) : HResult; stdcall;
		GetUniquenessValue : function (idd : IDirectDrawSurface4; var lpValue : DWORD) : HResult; stdcall;
		ChangeUniquenessValue : function (idd : IDirectDrawSurface4) : HResult; stdcall;
	end;

	__IDirectDrawSurface7This = ^__IDirectDrawSurface7Methods;
	__IDirectDrawSurface7Methods = packed record
		// ( methods
		// IDirectDrawSurface7 methods
		QueryInterface : function (idd : IDirectDrawSurface7; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawSurface7) : Longint; stdcall;
		Release : function (idd : IDirectDrawSurface7) : Longint; stdcall;
		AddAttachedSurface : function (idd : IDirectDrawSurface7; lpDDSAttachedSurface : IDirectDrawSurface7) : HResult; stdcall;
		AddOverlayDirtyRect : function (idd : IDirectDrawSurface7; const lpRect : TRect) : HResult; stdcall;
		Blt : function (idd : IDirectDrawSurface7; lpDestRect : PRect; lpDDSrcSurface : IDirectDrawSurface7; lpSrcRect : PRect; dwFlags : DWORD; lpDDBltFx : PDDBltFX) : HResult; stdcall;
		BltBatch : function (idd : IDirectDrawSurface7; const lpDDBltBatch : TDDBltBatch; dwCount : DWORD; dwFlags : DWORD) : HResult; stdcall;
		BltFast : function (idd : IDirectDrawSurface7; dwX : DWORD; dwY : DWORD; lpDDSrcSurface : IDirectDrawSurface7; lpSrcRect : PRect; dwTrans : DWORD) : HResult; stdcall;
		DeleteAttachedSurface : function (idd : IDirectDrawSurface7; dwFlags : DWORD; lpDDSAttachedSurface : IDirectDrawSurface7) : HResult; stdcall;
		EnumAttachedSurfaces : function (idd : IDirectDrawSurface7; lpContext : Pointer; lpEnumSurfacesCallback : TDDEnumSurfacesCallback7) : HResult; stdcall;
		EnumOverlayZOrders : function (idd : IDirectDrawSurface7; dwFlags : DWORD; lpContext : Pointer; lpfnCallback : TDDEnumSurfacesCallback7) : HResult; stdcall;
		Flip : function (idd : IDirectDrawSurface7; lpDDSurfaceTargetOverride : IDirectDrawSurface7; dwFlags : DWORD) : HResult; stdcall;
		GetAttachedSurface : function (idd : IDirectDrawSurface7; const lpDDSCaps : TDDSCaps2; var lplpDDAttachedSurface : IDirectDrawSurface7) : HResult; stdcall;
		GetBltStatus : function (idd : IDirectDrawSurface7; dwFlags : DWORD) : HResult; stdcall;
		GetCaps : function (idd : IDirectDrawSurface7; var lpDDSCaps : TDDSCaps2) : HResult; stdcall;
		GetClipper : function (idd : IDirectDrawSurface7; var lplpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		GetColorKey : function (idd : IDirectDrawSurface7; dwFlags : DWORD; var lpDDColorKey : TDDColorKey) : HResult; stdcall;
		GetDC : function (idd : IDirectDrawSurface7; var lphDC : HDC) : HResult; stdcall;
		GetFlipStatus : function (idd : IDirectDrawSurface7; dwFlags : DWORD) : HResult; stdcall;
		GetOverlayPosition : function (idd : IDirectDrawSurface7; var lplX , lplY : LongInt) : HResult; stdcall;
		GetPalette : function (idd : IDirectDrawSurface7; var lplpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		GetPixelFormat : function (idd : IDirectDrawSurface7; var lpDDPixelFormat : TDDPixelFormat) : HResult; stdcall;
		GetSurfaceDesc : function (idd : IDirectDrawSurface7; var lpDDSurfaceDesc : TDDSurfaceDesc2) : HResult; stdcall;
		Initialize : function (idd : IDirectDrawSurface7; lpDD : IDirectDraw; var lpDDSurfaceDesc : TDDSurfaceDesc2) : HResult; stdcall;
		IsLost : function (idd : IDirectDrawSurface7) : HResult; stdcall;
		Lock : function (idd : IDirectDrawSurface7; lpDestRect : PRect; var lpDDSurfaceDesc : TDDSurfaceDesc2; dwFlags : DWORD; hEvent : THandle) : HResult; stdcall;
		ReleaseDC : function (idd : IDirectDrawSurface7; hDC : Windows.HDC) : HResult; stdcall;
		_Restore : function (idd : IDirectDrawSurface7) : HResult; stdcall;
		SetClipper : function (idd : IDirectDrawSurface7; lpDDClipper : IDirectDrawClipper) : HResult; stdcall;
		SetColorKey : function (idd : IDirectDrawSurface7; dwFlags : DWORD; lpDDColorKey : PDDColorKey) : HResult; stdcall;
		SetOverlayPosition : function (idd : IDirectDrawSurface7; lX , lY : LongInt) : HResult; stdcall;
		SetPalette : function (idd : IDirectDrawSurface7; lpDDPalette : IDirectDrawPalette) : HResult; stdcall;
		Unlock : function (idd : IDirectDrawSurface7; lpRect : PRect) : HResult; stdcall;
		UpdateOverlay : function (idd : IDirectDrawSurface7; lpSrcRect : PRect; lpDDDestSurface : IDirectDrawSurface7; lpDestRect : PRect; dwFlags : DWORD; lpDDOverlayFx : PDDOverlayFX) : HResult; stdcall;
		UpdateOverlayDisplay : function (idd : IDirectDrawSurface7; dwFlags : DWORD) : HResult; stdcall;
		UpdateOverlayZOrder : function (idd : IDirectDrawSurface7; dwFlags : DWORD; lpDDSReference : IDirectDrawSurface7) : HResult; stdcall;
		GetDDInterface : function (idd : IDirectDrawSurface7; var lplpDD : IUnknown) : HResult; stdcall;
		PageLock : function (idd : IDirectDrawSurface7; dwFlags : DWORD) : HResult; stdcall;
		PageUnlock : function (idd : IDirectDrawSurface7; dwFlags : DWORD) : HResult; stdcall;
		SetSurfaceDesc : function (idd : IDirectDrawSurface7; const lpddsd2 : TDDSurfaceDesc2; dwFlags : DWORD) : HResult; stdcall;
		SetPrivateData : function (idd : IDirectDrawSurface7; const guidTag : TGUID; lpData : pointer; cbSize : DWORD; dwFlags : DWORD) : HResult; stdcall;
		GetPrivateData : function (idd : IDirectDrawSurface7; const guidTag : TGUID; lpBuffer : pointer; var lpcbBufferSize : DWORD) : HResult; stdcall;
		FreePrivateData : function (idd : IDirectDrawSurface7; const guidTag : TGUID) : HResult; stdcall;
		GetUniquenessValue : function (idd : IDirectDrawSurface7; var lpValue : DWORD) : HResult; stdcall;
		ChangeUniquenessValue : function (idd : IDirectDrawSurface7) : HResult; stdcall;
		SetPriority : function (idd : IDirectDrawSurface7; dwPriority : DWORD) : HResult; stdcall;
		GetPriority : function (idd : IDirectDrawSurface7; var lpdwPriority : DWORD) : HResult; stdcall;
		SetLOD : function (idd : IDirectDrawSurface7; dwMaxLOD : DWORD) : HResult; stdcall;
		GetLOD : function (idd : IDirectDrawSurface7; var lpdwMaxLOD : DWORD) : HResult; stdcall;
	end;

	__IDirectDrawColorControlThis = ^__IDirectDrawColorControlMethods;
	__IDirectDrawColorControlMethods = packed record
		// ( methods
		// IDirectDrawColorControl methods
		QueryInterface : function (idd : IDirectDrawColorControl; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawColorControl) : Longint; stdcall;
		Release : function (idd : IDirectDrawColorControl) : Longint; stdcall;
		GetColorControls : function (idd : IDirectDrawColorControl; var lpColorControl : TDDColorControl) : HResult; stdcall;
		SetColorControls : function (idd : IDirectDrawColorControl; const lpColorControl : TDDColorControl) : HResult; stdcall;
	end;

	__IDirectDrawGammaControlThis = ^__IDirectDrawGammaControlMethods;
	__IDirectDrawGammaControlMethods = packed record
		// ( methods
		// IDirectDrawGammaControl methods
		QueryInterface : function (idd : IDirectDrawGammaControl; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawGammaControl) : Longint; stdcall;
		Release : function (idd : IDirectDrawGammaControl) : Longint; stdcall;
		GetGammaRamp : function (idd : IDirectDrawGammaControl; dwFlags : DWORD; var lpRampData : TDDGammaRamp) : HResult; stdcall;
		SetGammaRamp : function (idd : IDirectDrawGammaControl; dwFlags : DWORD; const lpRampData : TDDGammaRamp) : HResult; stdcall;
	end;
...
const
	...
	IID_IDirectDraw7 : TGUID = (D1:$15e65ec0;D2:$3b9c;D3:$11d2;D4:($b9,$2f,$00,$60,$97,$97,$ea,$5b));
	...
	IID_IDirectDrawSurface7 : TGUID = (D1:$06675a80;D2:$3b9b;D3:$11d2;D4:($b9,$2f,$00,$60,$97,$97,$ea,$5b));
...
var
  ...
  DirectDrawCreate : function (lpGUID: PGUID;
       var lplpDD: IDirectDraw;
       pUnkOuter: IUnknown) : HResult; stdcall;
  DirectDrawCreateEx : function  (lpGUID: PGUID;
       var lplpDD: IDirectDraw7; const iid: TGUID;
       pUnkOuter: IUnknown) : HResult; stdcall;
...
{$ELSE}
	IDirectDrawVideoPort = ^__IDirectDrawVideoPortThis;
	IDDVideoPortContainer = ^__IDDVideoPortContainerThis;

	__IDirectDrawVideoPortThis = ^__IDirectDrawVideoPortMethods;
	__IDirectDrawVideoPortMethods = packed record
		// IDirectDrawVideoPort methods
		QueryInterface : function (idd : IDirectDrawVideoPort; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDirectDrawVideoPort) : Longint; stdcall;
		Release : function (idd : IDirectDrawVideoPort) : Longint; stdcall;
		Flip : function (idd : IDirectDrawVideoPort; lpDDSurface : IDirectDrawSurface; dwFlags : DWORD) : HResult; stdcall;
		GetBandwidthInfo : function (idd : IDirectDrawVideoPort; var lpddpfFormat : TDDPixelFormat; dwWidth : DWORD; dwHeight : DWORD; dwFlags : DWORD; var lpBandwidth : TDDVideoPortBandWidth) : HResult; stdcall;
		GetColorControls : function (idd : IDirectDrawVideoPort; var lpColorControl : TDDColorControl) : HResult; stdcall;
		GetInputFormats : function (idd : IDirectDrawVideoPort; var lpNumFormats : DWORD; var lpFormats : TDDPixelFormat; dwFlags : DWORD) : HResult; stdcall;
		GetOutputFormats : function (idd : IDirectDrawVideoPort; var lpInputFormat : TDDPixelFormat; var lpNumFormats : DWORD; lpFormats : PDDPixelFormat; dwFlags : DWORD) : HResult; stdcall;
		GetFieldPolarity : function (idd : IDirectDrawVideoPort; var lpbVideoField : BOOL) : HResult; stdcall;
		GetVideoLine : function (idd : IDirectDrawVideoPort; var lpdwLine : DWORD) : HResult; stdcall;
		GetVideoSignalStatus : function (idd : IDirectDrawVideoPort; varlpdwStatus : DWORD) : HResult; stdcall;
		SetColorControls : function (idd : IDirectDrawVideoPort; var lpColorControl : TDDColorControl) : HResult; stdcall;
		SetTargetSurface : function (idd : IDirectDrawVideoPort; lpDDSurface : IDirectDrawSurface; dwFlags : DWORD) : HResult; stdcall;
		StartVideo : function (idd : IDirectDrawVideoPort; var lpVideoInfo : TDDVideoPortInfo) : HResult; stdcall;
		StopVideo : function (idd : IDirectDrawVideoPort) : HResult; stdcall;
		UpdateVideo : function (idd : IDirectDrawVideoPort; var lpVideoInfo : TDDVideoPortInfo) : HResult; stdcall;
		WaitForSync : function (idd : IDirectDrawVideoPort; dwFlags : DWORD; dwLine : DWORD; dwTimeout : DWORD) : HResult; stdcall;
	end;

	__IDDVideoPortContainerThis = ^__IDDVideoPortContainerMethods;
	__IDDVideoPortContainerMethods = packed record
		// IDDVideoPortContainer methods
		QueryInterface : function (idd : IDDVideoPortContainer; const IID : TGUID; var obj) : HRESULT; stdcall;
		AddRef : function (idd : IDDVideoPortContainer) : Longint; stdcall;
		Release : function (idd : IDDVideoPortContainer) : Longint; stdcall;
		CreateVideoPort : function (idd : IDDVideoPortContainer; dwFlags : DWORD; var lpTDDVideoPortDesc : TDDVideoPortDesc; var lplpDDVideoPort : IDirectDrawVideoPort; pUnkOuter : IUnknown) : HResult; stdcall;
		EnumVideoPorts : function (idd : IDDVideoPortContainer; dwFlags : DWORD; lpTDDVideoPortCaps : PDDVideoPortCaps; lpContext : Pointer; lpEnumVideoCallback : TDDEnumVideoCallback) : HResult; stdcall;
		GetVideoPortConnectInfo : function (idd : IDDVideoPortContainer; dwPortId : DWORD; var lpNumEntries : DWORD; lpConnectInfo : PDDVideoPortConnect) : HResult; stdcall;
		QueryVideoPortStatus : function (idd : IDDVideoPortContainer; dwPortId : DWORD; var lpVPStatus : TDDVideoPortStatus) : HResult; stdcall;
	end;
