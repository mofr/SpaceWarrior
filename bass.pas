...
function BASS_SPEAKER_N(n: DWORD): DWORD;
begin
  BASS_SPEAKER_N:= n shl 24;
end;

function MAKEMUSICPOS(order,row: DWORD): DWORD;
begin
  MAKEMUSICPOS:= $80000000 or DWORD(MAKELONG(order,row));
end;
...
begin
  case (env) of
    ...
    EAX_ENVIRONMENT_HANGAR:
      BASS_SetEAXPreset := BASS_SetEAXParameters(EAX_ENVIRONMENT_HANGAR, 0.5, 10.0, 0.3);
    EAX_ENVIRONMENT_CARPETEDHALLWAY:
      BASS_SetEAXPreset := BASS_SetEAXParameters(EAX_ENVIRONMENT_CARPETEDHALLWAY, 0.153, 0.259, 2.0);
